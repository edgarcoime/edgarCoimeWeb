...
// var zergDeathSound = new Audio();
// zergDeathSound.src = "src/zergling/zerglingDeath.wav";
// var bgMusic = new Audio();
// bgMusic.src = "src/background/zerg-one.mp3";
// var menuMusic = new Audio();
// menuMusic.src = "src/menu/main-theme-title.mp3";
// var zergWin = new Audio();
// zergWin = "src/menu/zerg-victory.mp3";
...
function countdown(count) {
    window.gameTime = setInterval(function() {
        ...
        if (count === 0) {
            document.querySelector("#spawnArea").innerHTML = "<h1 class='game-win'>YOU WIN! You protected the Nexus</h1>";
